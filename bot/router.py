...
TOPICS = [
    {
        ...
        "keywords": [
            ...
            "onde buscar cliente", "atrair cliente",
        ],
    },
    {
        "id": "abordagem",
        ...
        "keywords": [
            ...
            "mensagem inicial", "como escrever",
        ],
    },
    {
        "id": "mentalidades",
    ...
    },
    {
        ...
        "keywords": [
            ...
            "cliente que não respondeu", "follow-up",
        ],
    },
    {
        "id": "negociacao",
...
FALLBACK_FILES = ["00_principios_gerais.txt", "04_esteira.txt"]
...
def load_knowledge_for_query(query: str) -> str:
    ...
    if not sections:
        fallback_path = os.path.join(KNOWLEDGE_DIR, "00_principios_gerais.txt")
        try:
    ...
    logger.debug("Router: query=%r → arquivos=%s", query[:60], files)
    return "\n\n".join(sections)
